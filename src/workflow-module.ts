...
//           infer SubDeps
//         >
//           ? Ctx & ServicesFromDepsRecursive<SubDeps>
//           : never;
//       }[keyof Deps]
//     >;
//
...
//   WFReg extends Record<string, WorkflowDef<any, any, any, any, any>>,
// > = {
//   wf: ReturnType<typeof createWorkflow<A, S, WFReg>>;
//   services: S;
// };
//
// function createModule<
...
//
//   use?: Use;
//   define: (ctx: ModuleContext<A, S, DepWorkflows<Use>>) => Own;
// }): Module<A, S, Own, Use> {
//   const deps = (config.use ?? {}) as Use;
//
//   const wf = createWorkflow<A, S, DepWorkflows<Use>>();
//
//   const own = config.define({
//     wf,
//     services: {} as S,
...
// >() {
//   return function <
//     A extends ActionRegistry = Record<string, any>,
//     Use extends ModuleMap = {},
//     Own extends ModuleShape = {},
//   >(config: {
//     actionRegistry: A;
//     use?: Use;
//     define: (
//       ctx: ModuleContext<typeof config.actionRegistry, S, DepWorkflows<Use>>, // ✅ FIXED HERE
//     ) => Own;
//   }): Module<A, S, Own, Use> {
//     return createModule<A, S, Use, Own>(config);
//   };
// }
//
//
...
>() {
  ...
  >(config: {
    ...
    use?: Use;
    define: (
      ctx: ModuleContext<typeof config.actionRegistry, DepWorkflows<Use>, S>, // ✅ FIXED HERE
    ) => Own;
  }): Module<Reg, S, Own, Use> {
